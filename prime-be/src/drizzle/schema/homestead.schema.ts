...
export const homestead = table("homestead",{
    id: t.int("id").primaryKey().autoincrement(),
    code: t.varchar('code', { length: 21 }),
    name: t.varchar('name', { length: 100 }),
    area: t.decimal('area', { precision: 10, scale: 2 }),
    length: t.decimal('length', { precision: 10, scale: 2 }),
