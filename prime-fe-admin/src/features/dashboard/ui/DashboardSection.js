...
// 월별 카드형 차트는 하나의 데이터셋에서 탭에 따라 다른 지표만 바꿔 보여준다.
...
// 카테고리 분포는 mock 데이터를 바로 시각화하므로,
// 이후 API 연동 시에는 이 컴포넌트는 그대로 두고 데이터 소스만 바꾸면 된다.
...
// DashboardSection은 통계 mock과 inquiry selector를 함께 보여준다.
